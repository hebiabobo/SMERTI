...
save_dir = os.path.join(main_path, "News_Dataset/output")
corpus_name = "News_Dataset"
corpus = os.path.join(main_path, corpus_name)
formatted_file = os.path.join(corpus, "data/seq2seq_data/masked_train_headlines.txt")
formatted_file_valid = os.path.join(corpus, "data/seq2seq_data/masked_val_headlines.txt")
...
def trainIters(model_name, voc, pairs, encoder, decoder, encoder_optimizer, decoder_optimizer, embedding, encoder_n_layers, decoder_n_layers, save_dir, n_iteration, batch_size, print_every, save_every, clip, corpus_name, loadFilename):
    ...
    for iteration in range(start_iteration, n_iteration + 1):
        ...
        if (iteration % save_every == 0):
            ...
            print("Saving checkpoint file to {}".format(directory))
...
loadFilename = None
#checkpoint_iter = 30000  # Checkpoint that you wish to load from
