...
def get_test_lines(pos_list, neg_list, test_nouns):
    ...
    for noun in test_nouns:
        ...
        print("noun_lines_pos")
        print(noun_lines_pos)

        random.seed(3)
        random.shuffle(noun_lines_pos)  # 随机打乱排序
...
# 手动在top 10% most frequent nouns中挑选10个RE
test_nouns = ['book', 'product', 'time', 'price', 'quality', 'money', 'game', 'story', 'movie',
              'phone']  # for Amazon dataset
