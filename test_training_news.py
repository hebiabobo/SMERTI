...
# main_path = "/content/gdrive/My Drive/SMERTI-master/"
...
# masked_train_path = os.path.join(data_path, "mask_final_train_reviews.txt")
# unmasked_train_path = os.path.join(data_path, "final_train_reviews.txt")
#
# masked_val_path = os.path.join(data_path, "mask_final_valid_reviews.txt")
# unmasked_val_path = os.path.join(data_path, "final_valid_reviews.txt")
#
# masked_test_path = os.path.join(data_path, "mask_final_test_reviews.txt")
# unmasked_test_path = os.path.join(data_path, "final_test_reviews.txt")
...
# train.to_csv(r"D:\PycharmProjects\SMERTI-master\Amazon_Dataset\train.csv", index=False)
# val.to_csv(r"D:\PycharmProjects\SMERTI-master\Amazon_Dataset\val.csv", index=False)
# test.to_csv(r"D:\PycharmProjects\SMERTI-master\Amazon_Dataset\test.csv", index=False)
# train.to_csv("/content/gdrive/My Drive/SMERTI-master/News_Dataset/train.csv", index=False)
# val.to_csv("/content/gdrive/My Drive/SMERTI-master/News_Dataset/train.csv", index=False)
# test.to_csv("/content/gdrive/My Drive/SMERTI-master/News_Dataset/train.csv", index=False)
