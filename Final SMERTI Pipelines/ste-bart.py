...
def bart_generation_mask_to_unmask(masked_sentence):
    if '<mask>' not in masked_sentence:
        ...
        generated_ids = model.generate(input_ids, max_length=50, repetition_penalty=0.5, do_sample=True, top_k=50,
                                       top_p=0.8)
...
eval_path = os.path.join(eval_dir, "eval_reviews_(3).txt")
...
# For reviews
filtered_input_path = os.path.join(eval_dir, "reviews_filtered_input.txt")
path_20 = os.path.join(eval_dir, "reviews_output_20.txt")
path_40 = os.path.join(eval_dir, "reviews_output_40.txt")
path_60 = os.path.join(eval_dir, "reviews_output_60.txt")
path_80 = os.path.join(eval_dir, "reviews_output_80.txt")
