...
path = os.path.join(save_dir, "Yelp_transformer_15_full.pt")
...
baseline_dir = os.path.join(eval_dir, "baseline_result")
path_20 = os.path.join(baseline_dir, "news_output_20.txt")
path_40 = os.path.join(baseline_dir, "news_output_40.txt")
path_60 = os.path.join(baseline_dir, "news_output_60.txt")
path_80 = os.path.join(baseline_dir, "news_output_80.txt")
